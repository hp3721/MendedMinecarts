...
public class MendedMinecartsMod implements ModInitializer {
	...
	public static final BooleanSetting DISPLAY_CART_DATA_POS_BINARY = new BooleanSetting("BinaryPosition", false, new TranslatableText("mendedminecarts.display_cart_data.binary_position.description"));
